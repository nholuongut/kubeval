...
```
wget https://github.com/nholuongut/kubeval/releases/latest/download/kubeval-linux-amd64.tar.gz
...
```
wget https://github.com/nholuongut/kubeval/releases/latest/download/kubeval-darwin-amd64.tar.gz
...
```
brew tap nholuongut/nholuongut
...
```
scoop bucket add nholuongut https://github.com/nholuongut/bucket-nholuongut
...
```
$ docker run -it -v `pwd`/fixtures:/fixtures nholuongut/kubeval fixtures/*
